export default async function handler(req, res) {
  ...
  if (!platform || !niche || !contentType || !tone) return res.status(400).json({ error: 'Missing fields' });
